...
<form class="form-horizontal" role="form">
    ...
    <div class="form-group">
        <label for="manum" class="col-sm-3 control-label">MA#</label>
        <div class="col-sm-4">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-offset-3 col-sm-5">
            <button type="button" class="btn btn-primary col-xs-12" style="height: 70px; font-size: 30px"><span style="padding-top: 10px" class="glyphicon glyphicon-check"></span> Complete</button>
        </div>
    </div>
</form>